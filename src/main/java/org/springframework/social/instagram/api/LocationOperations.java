...
public interface LocationOperations {
	 ...
	 *            Location ID
	 * @param maxId
	 *            Will return media after this ID
	 * @param minId
	 *            Will return media before this ID
	 * @param minTimeStamp
	 *            Will return media after this UNIX time stamp
	 * @param maxTimeStamp
	 ...
	 *            Longitude of the center search coordinate
	 * @param distance
	 *            Distance, in meters, from center (max distance is 5000 meters)
	 * @return A list of locations
	 */
